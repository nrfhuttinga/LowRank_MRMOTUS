...
if isempty( history )
    width       = 0;
    if iscell( errFcn ) 
        width = numel(errFcn)+2;
        history = cell(maxIts,width);
    end
%     elseif ~isempty(errFcn), width = 1; 
%     end
...
function printFcn(k,history,plotting)
