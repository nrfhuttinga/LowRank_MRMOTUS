...
ref_im_parameters.total_readouts                = 700:67280;              	% Readouts to extract, we typically don't use the first 700 readouts to let the signal settle in a steady state first.
...
ref_im_parameters.binning_pars.return_extreme_phase    = 2;                	% 0 - return all phases, 1 - return inhale, 2 - return exhale
